...
/** \page orcarootipeedelweiss OrcaRoot IPE Edelweiss Decoder
  * This  is the OrcaRoot IPE Edelweiss Decoder (file orcaroot_ipe_edelweiss.cc)
  *
  ...
  *
  * History:
  *   - 2013-04-04 Cloned SLT IPE V4 KATRIN Electronics decoders/writers . -tb-
  ...
  */ //-tb- 2008-02-12
  ...
  // this part is for the IPE EDELWEISS crate
...
"\n"
"\n"
"Usage: orcaroot_ipe_edelweiss [options] [input file(s) / socket host:port]\n"
"\n"
...
"\n"
"Example usage (replace orcaroot by orcaroot_ipe_edelweiss):\n"
"orcaroot run194 \n"
"  Rootify local file run194 with default verbosity, output file label, etc.\n"
"orcaroot run*\n"
