...
#include "TROOT.h"
#include "ORKatrinV4SLTEventDecoder.hh"
#include "ORLogger.hh"


std::string ORKatrinV4SLTEventDecoder::GetParName(size_t iPar)
{
  switch(iPar) {
    case 0: return "crate";
    case 1: return "card";
...
UInt_t ORKatrinV4SLTEventDecoder::GetPar(UInt_t* record, size_t iPar, size_t /*iRow*/)
{
  switch(iPar) {
